...
(function () {
  ...
  function initRealEstateCounter() {
    const section = document.querySelector('.realestate-agent-counter');
    if (!section) return;
  ...
  document.addEventListener('DOMContentLoaded', initRealEstateCounter);
})();
// real estate page js end